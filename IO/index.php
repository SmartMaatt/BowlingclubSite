...
<head>
  ...
  <title>Logowanie-Wysokiej klasy kregielnia</title>
...
>
  <div class="app-content content">
    <div class="content-wrapper starwars1">
                ...
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
					  ...
					  <h3 style="font-weight: bold;" class="brand-text">Wysokiej klasy kręgielnia</h3>
                    </div>
                  </div>
                ...
                <div class="card-content">
                  <div class="card-body">
                    ...
                    <form class="form-horizontal form-simple" action="rozchodniaczki/loguj.php" method ="post" novalidate>
                      ...
                      <button type="submit" class="btn btn-info btn-lg btn-block btn-danger"><i class="ft-unlock"></i> Zaloguj</button>
					  <?php
